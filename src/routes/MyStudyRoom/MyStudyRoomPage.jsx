...
export default function MyStudyRoomPage() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col items-center px-4 py-4 gap-8">
      ...
      <div className="w-full max-w-[1000px] dark:bg-zinc-700 rounded-2xl shadow-[0_0_6px_rgba(0,0,0,0.1)] p-4">
        <div className="flex flex-col justify-center mx-auto gap-4 w-full">
          ...
          <div className="flex justify-center items-center font-bold w-full max-w-[1000px] rounded-2xl dark:bg-zinc-600 dark:text-white shadow-[0_0_6px_rgba(0,0,0,0.1)] p-4 mx-auto">
            🔔{" "}
            {showSkeleton ? (
      ...
      <div className="w-full dark:bg-zinc-700 flex flex-col rounded-2xl shadow-[0_0_6px_rgba(0,0,0,0.1)] p-4 gap-4 mt-4">
        ...
        {activeTab === "chat" && (
          <StudyChat
            maxHeightClass="max-h-[570px]"
            minHeightClass="min-h-[570px]"
          />
        )}
      </div>
