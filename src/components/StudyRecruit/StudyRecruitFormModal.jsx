          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                onChange={handleChange}
                className="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900 px-4 py-3 min-h-[180px] resize-none focus:outline-none focus:ring-2 focus:ring-[#0033cf] font-medium transition placeholder:text-zinc-400"
