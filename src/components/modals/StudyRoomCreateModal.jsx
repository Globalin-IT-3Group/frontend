      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            value={form.rule}
            onChange={handleChange}
            className="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900 px-4 py-3 min-h-[56px] resize-none focus:outline-none focus:ring-2 focus:ring-[#003CFF] font-medium transition placeholder:text-zinc-400"
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            value={form.notice}
            onChange={handleChange}
            className="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900 px-4 py-3 min-h-[48px] resize-none focus:outline-none focus:ring-2 focus:ring-[#003CFF] font-medium transition placeholder:text-zinc-400"
            placeholder="공지사항 (선택)"
          />
        </div>
        <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            min={2}
            max={4}
            className="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900 px-4 py-3 w-32 focus:outline-none focus:ring-2 focus:ring-[#003CFF] font-medium transition"
          />
          {maxUserError && (
        ...
        <button
          type="submit"
          className="rounded-xl bg-[#003CFF] hover:bg-blue-500 text-white font-bold text-lg py-3 shadow-lg transition disabled:bg-zinc-400 disabled:cursor-not-allowed cursor-pointer"
          disabled={loading}
        >
          {loading ? "생성 중..." : "방 생성하기"}
        </button>
