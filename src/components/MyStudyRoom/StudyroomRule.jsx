export default function StudyRoomRule({ rule }) {
  ...
  return (
    <div className="w-full h-[255px] dark:bg-zinc-500 rounded-2xl shadow-[0_0_6px_rgba(0,0,0,0.1)]">
      <div className="flex flex-col p-6">
        ...
        <div className="ml-16 text-base text-gray-700 dark:text-gray-200 whitespace-pre-line">
